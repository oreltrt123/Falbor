...
//         const messageWrapperClass = cn(
//           "relative max-w-[100%] rounded-lg px-4 py-3",
//           message.role === "user" ? "text-[15px] text-black w-full" : "ml-2 text-[15px] text-black",
//         )
...
//                                   "relative max-w-[100%] rounded-lg px-4 py-3",
//                                   message.role === "user"
//                                     ? "text-[15px] text-black w-full"
//                                     : "text-[15px] text-black",
//                                   isLong &&
//                                   !isExpanded &&
//                                   "max-h-32 overflow-hidden relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-8 after:bg-gradient-to-t after:to-transparent",
//                                 )}
//                                 style={message.role === "user" ? { backgroundColor: "#F0EEE6" } : undefined}
//                               >
//                                 <ReactMarkdown
//                                   remarkPlugins={[remarkGfm]}
//                                   components={{
