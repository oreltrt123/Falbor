...
//       <form onSubmit={handleSubmit} className={`relative bg-[#1b1b1b] ${getBorderClass()} border-3 rounded-md overflow-hidden`}>
//         <textarea
//           value={message}
//           onChange={(e) => setMessage(e.target.value)}
//           onKeyDown={handleKeyDown}
...
//           onBlur={() => setIsFocused(false)}
//           placeholder={placeholder}
//           className="w-full min-h-[140px] max-h-[200px] resize-none bg-transparent text-white placeholder:text-muted-foreground
...
//       {creditsData && (
//         <div className="bg-[#272727] p-2 mt-[-15px] z-[-10px] rounded-b-lg flex items-center justify-between text-sm text-muted-foreground px-1">
